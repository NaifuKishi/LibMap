...
mapData.mapElements = {
  ...
  ["QUEST.MISSING"]       = { addon = "LibMap", path = "gfx/mapIcons/iconQuestUnavailable.png", width = 32, height = 32, minZoom = 1, layer = LAYER_QUEST},
  ...
  ["RIFT.CRAFTING"]				  = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftCrafting.png"}, width = 36, height = 36, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ...
  ["RIFT.MINOR.ACTIVE.LIFE"]    = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftLife.png"}, width = 64, height = 64, anim = "rotation", minZoom = 2, layer = LAYER_RIFT},
  ["RIFT.MINOR.ACTIVE.AIR"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftAir.png"}, width = 64, height = 64, anim = "rotation", minZoom = 2, layer = LAYER_RIFT},
  ["RIFT.MINOR.ACTIVE.EARTH"]   = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftDeath.png"}, width = 64, height = 64, anim = "rotation", minZoom = 2, layer = LAYER_RIFT},
  ["RIFT.MINOR.ACTIVE.DEATH"]   = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftEarth.png"}, width = 64, height = 64, anim = "rotation", minZoom = 2, layer = LAYER_RIFT},

  ["RIFT.MINOR.UNSTABLE.FIRE"]      = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftFire.png"}, width = 36, height = 36, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.MINOR.UNSTABLE.WATER"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftWater.png"}, width = 36, height = 36, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.MINOR.UNSTABLE.LIFE"]      = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftLife.png"}, width = 36, height = 36, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.MINOR.UNSTABLE.AIR"]       = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftAir.png"}, width = 36, height = 36, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.MINOR.UNSTABLE.EARTH"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftEarth.png"}, width = 36, height = 36, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.MINOR.UNSTABLE.DEATH"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftDeath.png"}, width = 36, height = 36, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  
  ["RIFT.MINOR.UNSTABLE.NIGHTMARE"] = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftNightmare.png"}, width = 34, height = 34, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.MINOR.ACTIVE.NIGHTMARE"] = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftNightmare.png"}, width = 34, height = 34, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ...
  ["RIFT.MAJOR.ACTIVE.NIGHTMARE"]   = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftNightmare.png"}, width = 34, height = 34, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.MAJOR.UNSTABLE.NIGHTMARE"] = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftNightmare.png"}, width = 34, height = 34, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  
  ["RIFT.EXPERT.ACTIVE.FIRE"]      = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftExpertFire.png"}, width = 36, height = 36, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.EXPERT.ACTIVE.WATER"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftExpertWater.png"}, width = 36, height = 36, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.EXPERT.ACTIVE.LIFE"]      = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftExpertLife.png"}, width = 36, height = 36, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.EXPERT.ACTIVE.AIR"]       = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftExpertAir.png"}, width = 36, height = 36, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.EXPERT.ACTIVE.EARTH"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftExpertEarth.png"}, width = 36, height = 36, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.EXPERT.ACTIVE.DEATH"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftExpertDeath.png"}, width = 36, height = 36, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},

  ["RIFT.EXPERT.ACTIVE.NIGHTMARE"] = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftNightmare.png"}, width = 34, height = 34, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  
  ["RIFT.EXPERT.UNSTABLE.FIRE"]      = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftExpertFire.png"}, width = 36, height = 36, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.EXPERT.UNSTABLE.WATER"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftExpertWater.png"}, width = 36, height = 36, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.EXPERT.UNSTABLE.LIFE"]      = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftExpertLife.png"}, width = 36, height = 36, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.EXPERT.UNSTABLE.AIR"]       = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftExpertAir.png"}, width = 36, height = 36, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.EXPERT.UNSTABLE.EARTH"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftExpertEarth.png"}, width = 36, height = 36, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.EXPERT.UNSTABLE.DEATH"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftExpertDeath.png"}, width = 36, height = 36, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  
  ["RIFT.EXPERT.UNSTABLE.NIGHTMARE"] = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftNightmare.png"}, width = 34, height = 34, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  
  ["RIFT.RAID.ACTIVE.FIRE"]      = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftRaidFire.png"}, width = 36, height = 36, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.RAID.ACTIVE.WATER"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftRaidWater.png"}, width = 36, height = 36, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.RAID.ACTIVE.LIFE"]      = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftRaidLife.png"}, width = 36, height = 36, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.RAID.ACTIVE.AIR"]       = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftRaidAir.png"}, width = 36, height = 36, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.RAID.ACTIVE.EARTH"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftRaidEarth.png"}, width = 36, height = 36, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.RAID.ACTIVE.DEATH"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftRaidDeath.png"}, width = 36, height = 36, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  
  ["RIFT.RAID.ACTIVE.NIGHTMARE"] = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftNightmare.png"}, width = 34, height = 34, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  
  ["RIFT.RAID.UNSTABLE.FIRE"]      = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftRaidire.png"}, width = 36, height = 36, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.RAID.UNSTABLE.WATER"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftRaidWater.png"}, width = 36, height = 36, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.RAID.UNSTABLE.LIFE"]      = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftRaidLife.png"}, width = 36, height = 36, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.RAID.UNSTABLE.AIR"]       = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftRaidAir.png"}, width = 36, height = 36, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.RAID.UNSTABLE.EARTH"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftRaidEarth.png"}, width = 36, height = 36, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.RAID.UNSTABLE.DEATH"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftRaidDeath.png"}, width = 36, height = 36, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},

  ["RIFT.RAID.UNSTABLE.NIGHTMARE"] = {fill = {type = "texture", source = "LibMap", texture = "gfx/riftNightmare.png"}, width = 34, height = 34, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ...
  ["RESOURCE.ARTIFACT"] = {addon = "LibMap", path = "gfx/map/iconArtefact.png", width = 36, height = 36, minZoom = 10, layer = LAYER_RESSOURCE},
