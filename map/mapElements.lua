...
mapData.mapElements = {
  ...
  ["UNIT.TARGET.NEUTRAL"]   = { addon = "LibMap", path = "gfx/mapIcons/iconTargetRingNeutral.png", width = 32, height = 32, minZoom = 1, layer = 98},
  ["UNIT.TARGET.FRIENDLY"]  = { addon = "LibMap", path = "gfx/mapIcons/iconTargetRingFriendly.png", width = 32, height = 32, minZoom = 1, layer = 98},
  ["UNIT.TARGET.HOSTILE"]   = { addon = "LibMap", path = "gfx/mapIcons/iconTargetRingHostile.png", width = 32, height = 32, minZoom = 1, layer = 98},
  ...
  ["RIFT.MINOR.ACTIVE.EARTH"]   = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftEarth.png"}, width = 64, height = 64, anim = "rotation", minZoom = 1, layer = LAYER_RIFT},
  ["RIFT.MINOR.ACTIVE.DEATH"]   = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftDeath.png"}, width = 64, height = 64, anim = "rotation", minZoom = 1, layer = LAYER_RIFT},

  ["RIFT.MINOR.UNSTABLE.FIRE"]      = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftUnstableFire.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.MINOR.UNSTABLE.WATER"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftUnstableWater.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.MINOR.UNSTABLE.LIFE"]      = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftUnstableLife.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.MINOR.UNSTABLE.AIR"]       = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftUnstableAir.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.MINOR.UNSTABLE.EARTH"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftUnstableEarth.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.MINOR.UNSTABLE.DEATH"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftUnstableDeath.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  
  ["RIFT.MINOR.UNSTABLE.NIGHTMARE"] = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftNightmare.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.MINOR.ACTIVE.NIGHTMARE"]   = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftNightmare.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ...
  ["RIFT.MAJOR.ACTIVE.EARTH"]   = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftMajorEarth.png"}, width = 64, height = 64, anim = "rotation", minZoom = 1, layer = LAYER_RIFT},
  ["RIFT.MAJOR.ACTIVE.DEATH"]   = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftMajorDeath.png"}, width = 64, height = 64, anim = "rotation", minZoom = 1, layer = LAYER_RIFT},

  ["RIFT.MAJOR.UNSTABLE.FIRE"]    = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftUnstableFire.png"}, width = 64, height = 64, anim = "rotation", minZoom = 1, layer = LAYER_RIFT},
  ["RIFT.MAJOR.UNSTABLE.WATER"]   = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftUnstableWater.png"}, width = 64, height = 64, anim = "rotation", minZoom = 1, layer = LAYER_RIFT},
  ["RIFT.MAJOR.UNSTABLE.LIFE"]    = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftUnstableLife.png"}, width = 64, height = 64, anim = "rotation", minZoom = 1, layer = LAYER_RIFT},
  ["RIFT.MAJOR.UNSTABLE.AIR"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftUnstableAir.png"}, width = 64, height = 64, anim = "rotation", minZoom = 1, layer = LAYER_RIFT},
  ["RIFT.MAJOR.UNSTABLE.EARTH"]   = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftUnstableEarth.png"}, width = 64, height = 64, anim = "rotation", minZoom = 1, layer = LAYER_RIFT},
  ["RIFT.MAJOR.UNSTABLE.DEATH"]   = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftUnstableDeath.png"}, width = 64, height = 64, anim = "rotation", minZoom = 1, layer = LAYER_RIFT},

  ["RIFT.MAJOR.ACTIVE.NIGHTMARE"]   = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftMajorNightmare.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.MAJOR.UNSTABLE.NIGHTMARE"] = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftMajorNightmare.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  
  ["RIFT.EXPERT.ACTIVE.FIRE"]      = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftExpertFire.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.EXPERT.ACTIVE.WATER"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftExpertWater.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.EXPERT.ACTIVE.LIFE"]      = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftExpertLife.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.EXPERT.ACTIVE.AIR"]       = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftExpertAir.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.EXPERT.ACTIVE.EARTH"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftExpertEarth.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.EXPERT.ACTIVE.DEATH"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftExpertDeath.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.EXPERT.ACTIVE.NIGHTMARE"] = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftExpertNightmare.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  
  ["RIFT.EXPERT.UNSTABLE.FIRE"]      = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftUnstableFire.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.EXPERT.UNSTABLE.WATER"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftUnstableWater.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.EXPERT.UNSTABLE.LIFE"]      = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftUnstableLife.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.EXPERT.UNSTABLE.AIR"]       = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftUnstableAir.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.EXPERT.UNSTABLE.EARTH"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftUnstableEarth.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.EXPERT.UNSTABLE.DEATH"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftUnstableDeath.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},

  ["RIFT.EXPERT.UNSTABLE.NIGHTMARE"] = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftExpertNightmare.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  
  ["RIFT.RAID.ACTIVE.FIRE"]      = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftRaidFire.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.RAID.ACTIVE.WATER"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftRaidWater.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.RAID.ACTIVE.LIFE"]      = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftRaidLife.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.RAID.ACTIVE.AIR"]       = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftRaidAir.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.RAID.ACTIVE.EARTH"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftRaidEarth.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.RAID.ACTIVE.DEATH"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftRaidDeath.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.RAID.ACTIVE.NIGHTMARE"] = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftRaidNightmare.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  
  ["RIFT.RAID.UNSTABLE.FIRE"]      = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftUnstableFire.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.RAID.UNSTABLE.WATER"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftUnstableWater.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.RAID.UNSTABLE.LIFE"]      = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftUnstableLife.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.RAID.UNSTABLE.AIR"]       = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftUnstableAir.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.RAID.UNSTABLE.EARTH"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftUnstableEarth.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ["RIFT.RAID.UNSTABLE.DEATH"]     = {fill = {type = "texture", source = "LibMap", texture = "gfx/mapIcons/iconRiftUnstableDeath.png"}, width = 64, height = 64, minZoom = 1, anim = "rotation", layer = LAYER_RIFT},
  ...
  ["RESOURCE.ORE.COPPER"]       = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGray.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.ORE.THALASIT"]     = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGray.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.ORE.RHENIUM"]      = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGray.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.ORE.KARTHITE"]     = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGray.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.ORE.CARMINTIUM"]   = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGray.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.ORE.TITANIUM"]     = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGray.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.ORE.ATRAMENTIUM"]  = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGray.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.ORE.TIN"]          = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGray.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.ORE.CHROMITE"]     = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGray.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.ORE.COBALT"]       = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGray.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.ORE.IRON"]         = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGray.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.ORE.SILVER"]       = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGray.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.ORE.GOLD"]         = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGray.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.ORE.ORICHALCUM"]   = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGray.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.ORE.GANTIMITE"]    = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGray.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.ORE.PLATINUM"]     = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGray.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.ORE.BOLIDIUM"]     = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGray.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
      
  ["RESOURCE.WOOD.SAGEBRUSH"]   = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceBrown.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.WOOD.RUNEBIRCH"]   = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceBrown.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.WOOD.MADROSA"]     = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceBrown.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.WOOD.YEWLOG"]      = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceBrown.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.WOOD.SHADETHORN"]  = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceBrown.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.WOOD.KINGSWOOD"]   = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceBrown.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.WOOD.ASHWOOD"]     = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceBrown.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.WOOD.MAHOGANY"]    = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceBrown.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.WOOD.OAK"]         = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceBrown.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.WOOD.BIRCH"]       = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceBrown.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.WOOD.ELM"]         = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceBrown.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.WOOD.LINDEN"]      = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceBrown.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
        
  ["RESOURCE.PLANTS.BASILISKWEED"]    = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGreen.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE},
  ["RESOURCE.PLANTS.BLOODSHADE"]      = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGreen.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE},
  ["RESOURCE.PLANTS.DRAKEFOOT"]       = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGreen.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.PLANTS.TEMPESTFLOWER"]   = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGreen.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.PLANTS.LUCIDFLOWER"]     = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGreen.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.PLANTS.SARLEAF"]         = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGreen.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.PLANTS.GRIEVEBLOSSOM"]   = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGreen.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.PLANTS.TATTERTWIST"]     = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGreen.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.PLANTS.CREEPER"]         = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGreen.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.PLANTS.COASTALGLORY"]    = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGreen.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.PLANTS.GOLDENNETTLE"]    = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGreen.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.PLANTS.KRAKENWEED"]      = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGreen.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.PLANTS.WYVERNSPURR"]     = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGreen.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.PLANTS.ROCORCHID"]       = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGreen.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.PLANTS.TWILIGHT"]        = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGreen.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE},
  ["RESOURCE.PLANTS.FRAZZLE"]         = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGreen.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.PLANTS.CHIMERASCLOAK"]   = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGreen.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.PLANTS.DUSKGLORY"]       = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGreen.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.PLANTS.RAZORBRUSH"]      = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGreen.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE},
  ["RESOURCE.PLANTS.FAECAPMUSHROOMS"] = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGreen.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE},
  ["RESOURCE.PLANTS.XARTHIANTENDRIL"] = { addon = "LibMap", path = "gfx/mapIcons/iconRessourceGreen.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE},
  
  ["RESOURCE.ARTIFACT"] = {addon = "LibMap", path = "gfx/map/iconArtifact.png", width = 32, height = 32, minZoom = 10, layer = LAYER_RESSOURCE},

  ["RESOURCE.FISH"]     = { addon = "LibMap", path = "gfx/mapIcons/iconRessourcBlue.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
  ["RESOURCE.BOAT"]     = { addon = "LibMap", path = "gfx/mapIcons/iconRessourcBlue.png", width = 32, height = 32, minZoom = 1, layer = LAYER_RESSOURCE}, 
